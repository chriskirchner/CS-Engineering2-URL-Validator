    ...
    */
    ...
    public void testHostPartition(){
        ...
        ResultPair[] testHosts = {
            ...
            new ResultPair(start + "w.google.com", true),
            new ResultPair(start + "wWw.gOoGlE.cOm", true),
        ...
        for(int i = 0; i < testHosts.length; i++){
            ...
            collector.checkThat(
                "Expected result to be " + currentPair.valid + " for "+currentPair.item, result, equalTo(currentPair.valid));
            }
            /*if(currentPair.valid != result)
            {
                System.out.println("Expected Result for "+currentPair.item+"... "+currentPair.valid+" ... Actual result:" + result);
            }*/
    ...
    */
    ...
    public void testSchemePartition(){
        ...
        ResultPair[] testSchemes = {
            ...
            new ResultPair("mailto" + email, false),
    ...
    */  
    ...
    public void testQueryPartition(){
        ...
        ResultPair[] testQueries = {
            ...
            new ResultPair(start + "?qstuff", false),
